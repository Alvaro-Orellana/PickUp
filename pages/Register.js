...
function Register({ navigation }) {
    ...
    if (!fontsAreLoaded) {
        ...
        return (
            ...
            value={mail}
            />
            <TextInput placeholder="Contraseña" placeholderTextColor='gray' secureTextEntry={true}
            style={styles.mailInputPassword}
            onChangeText={text => onChangePassword(text)}
            value={password}
            />
            <CustomButton style={styles.buttonRegister}>
            CREAR CUENTA
            </CustomButton>
            <View style={{paddingTop: '5%'}}>
            <Text style={styles.terminos}>
            Al crear una cuenta estas aceptando nuestros terminos y condiciones de servicio
            </Text>
            </View>
            ...
            <TouchableOpacity>
            <Text style={{ textDecorationLine: 'underline', color: '#fff', fontFamily: 'SF_Pro_Text' }}>Ingresar</Text>
            </TouchableOpacity>
            </View>
            </View>
            )
